...
public class PlayerHud : MonoBehaviour
{
  ...
  private void OnGUI()
  {
    ...
    {
      GUI.DrawTexture(new Rect(10, 10, 40, 60), heart);
      GUI.DrawTexture(new Rect(60, 10, 40, 60), heart);
      GUI.DrawTexture(new Rect(110, 10, 40, 60), heart);
    }
    else if(playerController.GetHealth() == 5)
    {
      GUI.DrawTexture(new Rect(10, 10, 40, 60), heart);
      GUI.DrawTexture(new Rect(60, 10, 40, 60), heart);
      GUI.DrawTexture(new Rect(110, 10, 40, 60), halfHeart);
    }
    ...
    {
      GUI.DrawTexture(new Rect(10, 10, 40, 60), heart);
      GUI.DrawTexture(new Rect(60, 10, 40, 60), halfHeart);
    }
    ...
    {
      GUI.DrawTexture(new Rect(10, 10, 40, 60), halfHeart);
    }
  }
}
